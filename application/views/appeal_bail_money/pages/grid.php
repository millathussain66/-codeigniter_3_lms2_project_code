...
#demos #camera {
  ...
  z-index: 999;
    ...
    jQuery(document).ready(function () {
                ...
                columns: [
                    ...
                    <? if(DELETE==1){?>
                        ...
                        cellsrenderer: function (row) {
                            ...
                            if((dataRecord.v_sts == 39 || dataRecord.v_sts == 35 || dataRecord.v_sts == 20) && dataRecord.life_cycle==1){
        ...
        var return_rules = [
            { input: '#return_reason', message: 'required!', action: 'keyup, blur', rule: function(input,commit){
            ...
            { input: '#return_reason', message: 'more than 250 characters', action: 'keyup, blur, change', rule: function (input, commit)
             {
                if(input.val() != '')
                {
                    if(input.val().length>250)
        ...
        <div id="verify_row" style="text-align:center;margin-bottom:30px;width:100%;">
            ...
            <table style="width:100%">
                <tr id="return_row" style="display:none;">
                    <td style="text-align:right;width: 40%;"><strong style="vertical-align:top">Return Reason<span style="color: red;">*</span></strong></td>
                    <td style="text-align:left;"><textarea name="return_reason" id="return_reason" style="width:370px;"></textarea></td>
                </tr>
                <tr>
                    <td colspan="2">
                        <input type="button" class="buttondelete" id="return_button" value="Return">
