...
/* .center {
  ...
  padding: 10px;
	...
	{
		if (jQuery('#reason').val() == '' && jQuery('#type').val()!='approve_auction') {
	...
	<form class="form" name="paper_form" id="paper_form" method="post" action="#">
		...
		<table  align="center" style="font-size:15px !important;margin-bottom:20px !important" border="0" cellspacing="0" cellpadding="2">
		  <tr align="center"><td style="border:0px; vertical-align:top;">		
			<br/>
				&nbsp;&nbsp;&nbsp;
				<input type="button" value="Approve" id="sendButton" onclick="delete_action('approve_auction')" class="btn-small btn-small-normal enabledElem" style="display: inline;cursor:pointer;font-size:16px;" />&nbsp;&nbsp;
				<input type="button" value="Return" id="sendToMakerButton" onclick="delete_action('return_auction')" class="btn-small btn-small-normal enabledElem" style="display: inline;;cursor:pointer;font-size:16px;" /> <span id="loading" style="display:none">Please wait... <img src="<?=base_url()?>images/loader.gif" align="bottom"></span><br/>
				<br/><br/>
			</td>
		  </tr>
		</table>
