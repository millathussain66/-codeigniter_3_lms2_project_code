...
<script type="text/javascript">
	jQuery().ready(function() {
        ...
        jQuery('#region,#territory,#district,#unit_office,#status,#limit').focusout(function() {
...
<? if($option == 'daily_report'){ ?>
	...
	jQuery().ready(function() {
        ...
        jQuery('#inXLadfc').attr('href','<?=base_url()?>index.php/auction_rt/mk_xl_daily_report/'+FromDate+'/'+ToDate+'/'+status_id+'/'+region_id);
                        ...
                        <tr>
                            ...
                            <td style="width:15%"><div style="padding-left:1.8%">
                                <select id="col_xl" tabindex="16" name="col_xl[]" multiple="multiple" style="width:250px">
                                    ...
                                    <option <?php if(!empty($col_xl)){if(in_array($key,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="<?=$key?>"><?=$val?></option>
                                <?php } ?>
        ...
        <table  style="background-color:#CCC" align="center" border="0" cellpadding="1" cellspacing="2" width="98%">
            ...
            <tr>
                ...
                <td align="left"  width="20%">
                    ...
                    <select name="region_id" id="region_id" onchange="change_branch()">
                            <option value="0">All Region </option>
                        <?php foreach($region_data as $region){ ?>
                            <option <?php echo ($region->id == $region_id) ? 'selected="selected"' : ''; ?> value="<?=$region->id?>"><?=$region->name?></option>
                        <?php } ?>
                    </select>
                </td>
                <td align="left"  width="30%">
