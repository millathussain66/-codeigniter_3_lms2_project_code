...
<script type="text/javascript">
	...
	function call_ajax_submit()
	{
		...
		jQuery.ajax({
				type: "POST",
				cache: false,
				url: '<?=base_url()?>index.php/authorization_ho/delete_action/',
				data : postData,
				datatype: "json",
    ...
    <input type="hidden" class="txt_csrfname"  name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
    	<form class="form" name="authorization_form" id="authorization_form" method="post" action="#">
	    	<table class="custtable" border="0" style="margin-left:10px;margin-top:10px;width:99%; font-size:15px;border-collapse:collapse">
				<?php if ($event_name=='cma'): ?>
					<tr>
						<td style="width:12%"><strong>Authorization Type</strong></td>
						<td style="width:30%">Filling Authorization</td>
						<td style="width:12%"><strong>Status</strong></td>
						<td style="width:30%"><?=$result->status;?></td>
					</tr>
					<tr>
						<td style="width:12%"><strong>Loan AC.</strong></td>
						<td style="width:30%"><?=$details->loan_ac;?></td>
						<td style="width:12%"><strong>AC Name</strong></td>
						<td style="width:30%"><?=$details->ac_name;?></td>
					</tr>
					<tr>
						<td style="width:12%"><strong>Selected Lawyer</strong></td>
						<td style="width:30%"><?=$details->lawyer;?></td>
						<td style="width:12%"><strong>Legal Notice Sent Date</strong></td>
						<td style="width:30%"><?=$details->ln_sent_date;?></td>
					</tr>
					<tr>
						<td style="width:12%"><strong>Legal Notice Validity Date</strong></td>
						<td style="width:30%"><?=$details->ln_val_dt;?></td>
						<td style="width:12%"><strong>Legal Notice Status</strong></td>
						<td style="width:30%"><?=$details->ln_status;?></td>
					</tr>
					<tr>
					<td style="width:12%"><strong>Final Legal Notice</strong></td>
					<td style="width:30%">
						<?php if ($details->final_ln!=''): ?>
							<img id="file_preview" onclick="popup('<?=base_url()?>cma_file/ln_scan_copy/<?=$details->final_ln?>')" style=" cursor:pointer;text-align:center" height="18" src="<?=base_url()?>old_assets/images/print-preview.png">
						<?php endif ?>
					</td>
					...
					<tr>
						...
						<td style="width:30%"><?=$result->sfa_by;?></td>
						<td style="width:12%"><strong>Send For Authorization Date</strong></td>
						<td style="width:30%"><?=$result->sfa_dt;?></td>
					</tr>				
				<?php endif ?>
				<?php if ($event_name=='suit_file'): ?>
					...
					<tr>
						<td style="width:12%"><strong>Send For Authorization By</strong></td>
						<td style="width:30%"><?=$details->sfa_by;?></td>
						<td style="width:12%"><strong>Send For Authorization Date</strong></td>
						<td style="width:30%"><?=$details->sfa_dt;?></td>
					</tr>
				<?php endif ?>
				<?php if ($type==3): ?>
					<tr>
						<td style="width:12%"><strong>Authorization Type</strong></td>
						<td style="width:30%"><?=$result->type;?></td>
						<td style="width:12%"><strong>Status</strong></td>
						<td style="width:30%"><?=$result->status;?></td>
					</tr>
					...
					<tr>
						<td style="width:12%"><strong>Case Number</strong></td>
						<td style="width:30%"><?=$details->case_number;?></td>
						<td style="width:12%"><strong>Arrested</strong></td>
						<td style="width:30%"><?=$details->arrested;?></td>
					</tr>
					
				
					<tr>
						<td style="width:12%"><strong>Deposited Amount</strong></td>
						<td style="width:30%"><?=$details->deposit_amt?></td>
						<td style="width:12%"><strong>Deposit Date</strong></td>
						<td style="width:30%"><?=$details->deposit_date?></td>
					</tr>
