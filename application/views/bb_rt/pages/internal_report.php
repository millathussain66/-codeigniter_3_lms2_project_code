    ...
    <script type="text/javascript">
        ...
        function search_data()
        {
            ...
            else
            {
                ...
                jQuery.ajax({
                url: '<?php echo base_url(); ?>index.php/bb_rt/get_internal_report',
                async:false,
                type: "post",
                data: {[csrfName]: csrfHash,year : item.value},
                datatype: "json",
                success: function(response){
                        ...
                        jQuery('#submit').show();
                         ...
                         jQuery('#statement_xl').attr('href','<?=base_url()?>Bb_rt/make_case_filed_xl_internal/'+item.value);
                    },
                                   ...
                                   <div style="padding: 0.5%;width:98%;height:60px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                        <table id="deal_body" style="display:block;width:100%">
                                            <tr>
                                                ...
                                                <td style=""><div style="padding-left:1.8%" id="year" name="year"></div></td>
