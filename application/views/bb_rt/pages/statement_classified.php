...
/* .center {
  ...
  padding: 10px;
    ...
    <script type="text/javascript">
            ...
            jQuery("#branch_sol").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Branch SOL", source: branch_sol, width: 250, height: 25});
        ...
        function search_data()
        {
            ...
            else
            {
                ...
                jQuery.ajax({
                url: '<?php echo base_url(); ?>index.php/bb_rt/get_statement_result_classified',
                async:false,
                type: "post",
                data: {[csrfName]: csrfHash,branch : item.value},
                datatype: "json",
                success: function(response){
                        ...
                        jQuery('#submit').show();
                         ...
                         jQuery('#statement_xl').attr('href','<?=base_url()?>Bb_rt/make_statement_xl_classified/'+item.value);
                    },
                ...
                <tr id="widgetsNavigationTree">
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div >
                                    ...
                                    <input type="hidden" class="txt_csrfname"  name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                                       <div style="padding: 0.5%;width:98%;height:60px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                            <table id="deal_body" style="display:block;width:100%">
                                                <tr>
                                                    <td style=""><strong>Branch SOL&nbsp;&nbsp;</strong> </td>
                            ...
                            <?php else: ?>
                                <h1 style="text-align: center">Sorry you have no access for this operation</h1>
                            <?php endif ?>
                        </div>
                    </td>
                </tr>
