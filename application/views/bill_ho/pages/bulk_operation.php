...
<script type="text/javascript">
	...
	jQuery(document).ready(function () {
		...
		jQuery("#vendor").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Select Vendor", source: vendor, width: '98%', height: 25});
        ...
        success: function(response){
        	var json = jQuery.parseJSON(response);
					...
					if (operation=='legal_district_lawyer') 
                    {
                        ...
                        jQuery("#vendor").jqxComboBox({theme: theme, autoDropDownHeight: false, promptText: "Select Lawyer", source: lawyer, width: '98%', height: 25});
	...
	function search_data()
	{
		...
		jQuery.ajax({
				type: "POST",
				cache: false,
				url: "<?=base_url()?>index.php/bill_ho/load_bulk_data/",
				data : postdata,
				datatype: "json",
				success: function(response){
						var json = jQuery.parseJSON(response);
	...
	function details(id,operation,module_name=null)
	{
		...
		else if(module_name=='court_fee')
		{
			var url = "<?=base_url()?>bill_ho/court_fee_details";
		}
		else if(module_name=='paper_bill')
		{
			var url = "<?=base_url()?>bill_ho/paper_bill_details";
		}
		else if(module_name=='court_enter')
		{
			var url = "<?=base_url()?>bill_ho/court_bill_details";
		}
	...
	function call_ajax_submit()
	{
		...
		jQuery.ajax({
			type: "POST",
			cache: false,
			url: '<?=base_url()?>index.php/bill_ho/bulk_acktion/',
			data : postData,
			datatype: "json",
			success: function(response){
			...
			<div style="margin-left:10px;padding: 0.5%;width:98%;height:65px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
					<table id="deal_body" style="display:block;width:100%">
						<tr>
							...
							<td style="width:5%"><div id="vendor" tabindex="28" name="vendor" style="padding-left: 3px"></div></td>
