...
$pdf->SetAuthor("MMTV");
$pdf->SetTitle("lawyer bill");
$pdf->SetSubject("lawyer bill");
...
$html.='<table style="border:1px solid #000;">
		...
		<tr>
			<td >Purpose</td>
			<td >:</td>
			<td colspan="4">'.$vendor_type.' Bill</td>
		</tr>';
		$no_of_account = 0;
	        $total_amount = 0;
	        if (!empty($details)) 
		...
		<tr>
			...
			<td style="border-top:1px solid #000;border-left:1px solid #000;font-size: 9px;border-right:1px solid #000;" colspan="3" >GL Name : Legal Expense Loan Recovery</td>
			<td style="border-top:1px solid #000;" colspan="2" rowspan="8" ></td>
		</tr>
		<tr>
