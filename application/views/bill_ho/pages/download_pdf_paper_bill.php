...
class MYPDF extends TCPDF {
	...
	function showHeader()
	{
		...
		$this->Cell(180,0,"Brack Bank Ltd.",'',2,'C',0);
...
$pdf->SetAuthor("MMTV");
$pdf->SetTitle("Paper BILL");
$pdf->SetSubject("Paper BILL");
...
$html.='<table style="border:1px solid #000;">
		...
		<tr>
			...
			<td >:</td>
			<td colspan="4">'.$amount_in_word.' Only</td>
		</tr>
		<tr>
		...
		if($special_bill_sts==1){
			...
			$html.='<tr>
					...
					<tr>
						<td colspan="6" style="border:1px solid #000;">Note : '.$memo_remarks.'</td>
					</tr>';
		}
		...
		<tr>
			<td colspan="2" style="border-top:1px solid #000;text-align:center;">Initiated by </td>
			<td ></td>
			<td ></td>
			<td style="border-top:1px solid #000;text-align:center;" colspan="2" >Verified By</td>
		</tr>
		<tr>
			<td style="text-align:center;" colspan="2">Krishna Gopal Kundu (PIN:25205)</td>
			<td ></td>
			<td ></td>
			<td colspan="2" style="text-align:center;">Sabbir Abedin (PIN:4402)</td>
		</tr>
		<tr>
			<td style="text-align:center;" colspan="2">Officer,Litigation Management</td>
			<td ></td>
			<td ></td>
			<td colspan="2" style="text-align:center;">Sr.Manager,Litigation Management</td>
		</tr>
		<tr>
		...
		if($special_bill_sts==1){
			...
			<tr>
				<td style="border-top:1px solid #000;text-align:center;" colspan="2">Supported By </td>
				<td ></td>
				<td ></td>
				<td style="border-top:1px solid #000;text-align:center;" colspan="2" >Recommended by</td>
			</tr>
			<tr>
				<td style="text-align:center;" colspan="2">Mustafizur Rahman (PIN-26017)</td>
				<td ></td>
				<td ></td>
				<td colspan="2" style="text-align:center;">Rasheed Ahmed (PIN-3979)</td>
			</tr>
			<tr>
				<td style="text-align:center;" colspan="2">Head Of Litigation Management Department</td>
				<td ></td>
				<td ></td>
				<td colspan="2" style="text-align:center;">Head of Legal & Recovery Division</td>
			</tr>
			<tr>
				<td style="text-align:center;" colspan="2">Legal & Recovery Division</td>
				<td ></td>
				<td ></td>
			...
			<tr>
				<td style="text-align:center;" colspan="2">Tareq Refat Ullah Khan (PIN-25344)</td>
				<td ></td>
				<td ></td>
				<td colspan="2" style="text-align:center;">Syed Abdul Momen (PIN-1441)</td>
			</tr>
			<tr>
				<td style="text-align:center;" colspan="2">DMD And Head Of corporate Banking Division</td>
				<td ></td>
				<td ></td>
				<td colspan="2" style="text-align:center;">DMD And Head Of SME Banking </td>
			</tr>
			<tr>
			...
			<tr>
				<td ></td>
				<td colspan="3" style="text-align:center;">Selim R.F. Hossain (PIN-23500)</td>
				<td colspan="2" ></td>
			</tr>
			<tr>
				<td ></td>
				<td colspan="3" style="text-align:center;">Managing Director & CEO</td>
				<td colspan="2" ></td>
			</tr>';
		}
		else
		...
		<tr>
			...
			<td style="border-top:1px solid #000;font-size: 9px;border-left:1px solid #000;border-right:1px solid #000;" colspan="3" >GL Name : Legal Notice Publication</td>
			<td style="border-top:1px solid #000;font-size: 9px;" colspan="2" rowspan="8" ></td>
		</tr>
		<tr>
			<td colspan="3" style="border-left:1px solid #000;font-size: 9px;border-right:1px solid #000;">GL No: 630000139</td>
		</tr>
		<tr>
