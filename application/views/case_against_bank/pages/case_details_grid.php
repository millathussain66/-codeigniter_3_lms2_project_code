...
/* .center {
  ...
  padding: 10px;
    ...
    <script type="text/javascript">
            ...
            jQuery("#district").jqxComboBox({theme: theme, promptText: "Select district", source: district, width: 150, height: 25});
        jQuery("#limit").jqxComboBox({theme: theme, promptText: "Limit", source: limit, width: 150, height: 25});
            jQuery('#district').focusout(function() {
                commbobox_check(jQuery(this).attr('id'));
            });
            jQuery("#limit").jqxComboBox('val','All');
           ...
           change_caption();
            ...
            if (event.args.item == 0) {
                jQuery('#jqxTabsTab1').css({
                'background': '#d1d5d5',
                });

                jQuery('#jqxTabsTab0').css({
                'background': '#fff',
                });
            }
    ...
    function searchsuit()// customer search 
    {
        ...
        else
        {
            ...
            jQuery.ajax({
                ...
                cache: false,
                async:false,
                url: "<?=base_url()?>index.php/case_against_bank/get_case_details_result/",
                data : postData,
                datatype: "html",
    ...
    function details(id){
        ...
        jQuery.ajax({
            type: "POST",
            cache: false,
            url: "<?=base_url()?>case_against_bank/get_case_details_info",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div >
                            <div id='jqxTabs'>
                                ...
                                <div style="overflow: hidden;" class="back_image">
                                    <div id="search_area">
                                            <form method="POST" name="form" id="form"  style="margin:0px;" action="<?php echo base_url('case_against_bank/make_xl'); ?>">
                                            ...
                                            <table id="deal_body" class="search_table_row" style="display:none;width:90%">
                                                        <tr>
                                                            ...
                                                            <td style="width:5%"><div style="padding-left:1.8%" id="req_type" name="req_type"></div></td>
                                                        ...
                                                        <tr>
                                                            <td style="text-align:left;width:10%" colspan="2"><strong>Filing From&nbsp;</strong><input type="text" name="filling_dt_from" placeholder="dd/mm/yyyy" style="width:100px;" id="filling_dt_from" value="" ><script type="text/javascript" charset="utf-8">datePicker ("filling_dt_from");</script> </td>
                                                            
                                                            <td style="text-align:left;width:10%" colspan="2"><strong>TO &nbsp;</strong><input type="text" name="filling_dt_to" placeholder="dd/mm/yyyy" style="width:100px;" id="filling_dt_to" value="" ><script type="text/javascript" charset="utf-8">datePicker ("filling_dt_to");</script> </td>

                                                            <td style="text-align:left;width:10%" colspan="2"><strong>Next Date &nbsp;</strong><input type="text" name="next_date" placeholder="dd/mm/yyyy" style="width:100px;" id="next_date" value="" ><script type="text/javascript" charset="utf-8">datePicker ("next_date");</script> </td>
                                                            ...
                                                            <td style="text-align:right;width:5%"><strong></strong> </td>
                                    ...
                                    <div style="overflow:scroll;" id="main_div">
                                        <table class="" table border="1" id="facility_table" style="border-color:#c0c0c0;" >
                                            <thead>
                                                <tr>
                                                    <td width="2%" style="font-weight: bold;text-align:center">P</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Sl No</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">A/C Number</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">A/C Name</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">3 Type of case</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Type Of Case</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Filing Date</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Case Number</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Previous Date</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Case Status On The Previous</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Next Date</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Case Status Next Date</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Background /Case history</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Dealing Officer</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Lawyer</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">District</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Final Remarks</td>
                                                    <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Legal Cost</td>
                                                </tr>
                                            </thead>
                                            <tbody id="list_body">
                                            </tbody>
