...
<?php if ($operation=='apv_bill_mony_recovery_rt'): ?>
    <?php 
        ...
        $report_type = array();
        $report_type['1'] ='Pending';
        $report_type['2']='Recovery';
        $report_type['3']='Recovery & Pending';
        $report_type['4']='Comparison';
    ...
    <script type="text/javascript">
        ...
        var report_type = [<? $i=1; foreach($report_type as $key=>$row){ if($i!=1){echo ',';} echo '{value:"'.$key.'", label:"'.$row.'"}'; $i++;}?>];
        ...
        jQuery(document).ready(function () {
            jQuery("#from_year").jqxDropDownList({theme: theme,autoDropDownHeight: false, dropDownHeight: 100,promptText: "From",source: year, width: 100, height: 25});
            jQuery("#to_year").jqxDropDownList({theme: theme,autoDropDownHeight: false, dropDownHeight: 100,promptText: "To",source: year, width: 100, height: 25});
                jQuery("#from_year_s").jqxDropDownList({theme: theme,autoDropDownHeight: false, dropDownHeight: 100,promptText: "From",source: year, width: 215, height: 25});

            jQuery("#report_category").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Report Category", source: report_category, width: 215, height: 25});
            jQuery("#reporting_time").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Reporting Time", source: reporting_time, width: 215, height: 25});
                        jQuery("#report_type").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Report Type", source: report_type, width: 215, height: 25});
            

            jQuery("#reporting_period").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Reporting Period", source: reporting_period, width: 215, height: 25});
    ...
    function change_report_category_dropdown()
    {
        ...
        success: function(response){
                var json = jQuery.parseJSON(response);
                        ...
                        if(item.value==2)
                        {
                            jQuery("#report_category_dropdown_multi").jqxDropDownList({theme: theme,checkboxes: true, autoDropDownHeight: false, promptText: "Select",filterable: true,searchMode: 'containsignorecase', source: drop_down_data, width: 215, height: 25});
                            jQuery("#report_category_dropdown_multi").show();
                            jQuery("#report_category_dropdown").hide();
                        }
                        else
                        {
                            jQuery("#report_category_dropdown").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Select", source: drop_down_data, width: 215, height: 25});
    ...
    {
        var postdata = jQuery('#warrant_apv_bill_mony_recovery_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/case_file_rt/get_apv_bill_mony_recovery_rt_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="warrant_apv_bill_mony_recovery_form" id="warrant_apv_bill_mony_recovery_form" method="post" action="<?= base_url()?>Case_file_rt/warrant_apv_bill_mony_recovery_xl" enctype="multipart/form-data">
                                        ...
                                        <tbody>
                                            <tr>
                                               <td style="vertical-align: top;">
                                                ...
                                                <div style="float:left;display:none" id="from_year_s" name="from_year_s" style="padding-left: 3px"></div>

                                               </td> 

                                              <td style="vertical-align: top;">
                                                <div style="float:left" id="report_type" name="report_type" style="padding-left: 3px"></div><br>
                                               </td> 
