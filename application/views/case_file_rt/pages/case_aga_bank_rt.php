...
<?php if ($operation=='case_aga_bank_rt'): ?>
    <?php 
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#from_year_cat").jqxDropDownList({theme: theme,autoDropDownHeight: false, dropDownHeight: 100,promptText: "From",source: year, width: 100, height: 25});
            jQuery("#to_year_cat").jqxDropDownList({theme: theme,autoDropDownHeight: false, dropDownHeight: 100,promptText: "To",source: year, width: 100, height: 25});
            ...
            //jQuery("#req_type").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "3 Type Of Case", source: req_type, width: 215, height: 25});
            jQuery("#req_type").jqxDropDownList({theme: theme,checkboxes: true, autoDropDownHeight: false, promptText: "3 Type Of Case",filterable: true,searchMode: 'containsignorecase', source: req_type, width: 215, height: 25});
    ...
    {
        var postdata = jQuery('#case_aga_bank_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/case_file_rt/case_aga_bank_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="case_aga_bank_form" id="case_aga_bank_form" method="post" action="<?= base_url()?>Case_file_rt/case_aga_bank_lx" enctype="multipart/form-data">
