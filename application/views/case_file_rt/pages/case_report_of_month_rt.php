...
<?php if ($operation=='case_report_of_month_rt'): ?>
    <?php 
        $report_category = array();
        $report_category['0'] ='All';
        $report_category['1'] ='Region Wise';
        // $report_category['2']='Region Wise (Multi)';
        // $report_category['3']='Protfolio Wise';
        // $report_category['4']='Dealing Officer Wise';

        $report_category['7']='Year Wise';
        ...
        $present_status['0'] = 'All';
        $present_status['1'] = 'Running';
        $present_status['2'] = 'Settled';
        ...
        $req_type= array();
        $req_type['0'] = "All";
        $req_type['1'] = "High Court";
        $req_type['2'] = "Appellate";
    ...
    <script type="text/javascript">
        ...
        var req_type = [<? $i=1; foreach($req_type as $key=>$row){ if($i!=1){echo ',';} echo '{value:"'.$key.'", label:"'.$row.'"}'; $i++;}?>];
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#report_category").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Report Category", source: report_category, width: 150, height: 25});
            ...
            //jQuery("#req_type").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "3 Type Of Case", source: req_type, width: 150, height: 25});
            jQuery("#req_type").jqxDropDownList({theme: theme,checkboxes: true, autoDropDownHeight: false, promptText: "Division",filterable: true,searchMode: 'containsignorecase', source: req_type, width: 150, height: 25});
    ...
    {
        var postdata = jQuery('#case_report_of_month_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/case_file_rt/case_report_of_month_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="case_report_of_month_form" id="case_report_of_month_form" method="post" action="<?= base_url()?>Case_file_rt/case_report_of_month_xl" enctype="multipart/form-data">
                                ...
                                <div style="margin-left: 15px;float:left;display:none;" id="to_year_cat" name="to_year_cat" style="padding-left: 3px"></div>
                                               ...
                                               <td style="vertical-align: top;">
                                                <div style="float:left" id="req_type" name="req_type" style="padding-left: 3px"></div>
                                               </td> 
                                               ...
                                               <td style="vertical-align: top;">
                                                ...
                                                <input type="text" name="filling_dt_from" placeholder="From Date" style="display: none;width:100px;" id="filling_dt_from" value="" ><script type="text/javascript" charset="utf-8">datePicker ("filling_dt_from");</script>
                                                <input type="text" name="filling_dt_to" placeholder="To Date" style="display: none;width:100px;" id="filling_dt_to" value="" ><script type="text/javascript" charset="utf-8">datePicker ("filling_dt_to");</script>
                                               </td> 
