...
<?php if ($operation=='cma_apv__decline_rt'): ?>
    <?php 
        ...
        $report_category['1']='Product Wise';
       ...
       $reporting_period=array();
        ...
        $present_status['1'] = 'Approval';
        $present_status['2'] = 'Decline';
    ...
    {
        var postdata = jQuery('#cma_apv__decline_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/case_file_rt/cma_apv__decline_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="cma_apv__decline_form" id="cma_apv__decline_form" method="post" action="<?= base_url()?>Case_file_rt/cma_apv__decline_xl" enctype="multipart/form-data">
