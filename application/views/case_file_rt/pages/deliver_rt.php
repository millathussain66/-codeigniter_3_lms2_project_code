...
<?php if ($operation=='deliver_rt'): ?>
    <?php 
        ...
        $report_category_segment['3']='Protfolio Wise';

        $report_category=array();

        // $report_category['4']='Product Wise';
       ...
       $reporting_period=array();
        ...
        $present_status['1'] = 'Delivered';
        $present_status['2'] = 'Received';
        $present_status['3'] = 'Yet Not Received';
    ...
    {
        var postdata = jQuery('#deliver_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/case_file_rt/deliver_rt_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="deliver_form" id="deliver_form" method="post" action="<?= base_url()?>Case_file_rt/deliver_rt_xl" enctype="multipart/form-data">
