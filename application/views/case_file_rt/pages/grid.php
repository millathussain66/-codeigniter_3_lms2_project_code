...
<?php if ($operation=='case_file_rt'): ?>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#final_remarks").jqxDropDownList({theme: theme,checkboxes: true, autoDropDownHeight: false, promptText: "Present Status",filterable: true,searchMode: 'containsignorecase', source: final_remarks, width: 215, height: 25});
    ...
    {
        var postdata = jQuery('#case_file_rt_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/case_file_rt/get_case_filling_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="case_file_rt_form" id="case_file_rt_form" method="post" action="<?= base_url()?>Case_file_rt/case_file_rt_xl" enctype="multipart/form-data">
                                    ...
                                    <table style="width:100%;" id="tab1Table" >
                                        <tbody>
                                            <tr>
                                               ...
                                               <td style="vertical-align: top;">
                                                <div style="float:left" id="final_remarks" name="final_remarks" style="padding-left: 3px"></div>
                                               </td> 
                                               <td style="vertical-align: top;">
