...
<?php if ($operation=='high_court_rt'): ?>
    <?php 
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#present_status").jqxDropDownList({theme: theme,checkboxes: true, autoDropDownHeight: false, promptText: "Present Status",filterable: true,searchMode: 'containsignorecase', source: present_status, width: 150, height: 25});
    ...
    {
        var postdata = jQuery('#legal_cost_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/case_file_rt/legal_cost_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="legal_cost_form" id="legal_cost_form" method="post" action="<?= base_url()?>Case_file_rt/legal_cost_xl" enctype="multipart/form-data">
