...
<?php if ($operation == 'iss_rt') : ?>
    <?php
    $report_type = array();

    $report_type['1'] = 'All';
    $report_type['2'] = 'Running';
    $report_type['3'] = 'Settled';
    $report_type['4'] = 'Filing';
    ...
    $reporting_period['1'] = 'SOL';
    $reporting_period['2'] = 'Day';
    $reporting_period['3'] = 'Month';
    $reporting_period['4'] = 'Year';
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            // jQuery("#report_type").jqxComboBox('val',1);
        ...
        function submit_data() {
            ...
            var postdata = jQuery('#iss_rt_form').serialize();
            jQuery("#report_result").html('');
            jQuery("#report_generate").hide();
            jQuery("#grid_loading").show();

            jQuery.ajax({
                url: '<?php echo base_url(); ?>index.php/case_file_rt/get_iss_report_result',
                async: false,
                type: "post",
                data: postdata,
                datatype: "json",
                success: function(response) {
                    ...
                    if (item != null) {
                        ...
                        jQuery("#report_result").append(json.str3);
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                <div style="padding: 10px;" class="back_image">
                                    <form class="form" name="iss_rt_form" id="iss_rt_form" method="post" action="<?= base_url() ?>Case_file_rt/iss_rt_xl" enctype="multipart/form-data">
