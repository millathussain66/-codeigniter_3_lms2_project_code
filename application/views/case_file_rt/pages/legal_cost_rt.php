...
<?php if ($operation=='legal_cost_rt'): ?>
    <?php 
        ...
        $present_status['1'] = 'Disbursed';
        $present_status['2'] = 'Pending';
        ...
        $req_type= array();
        $req_type['1'] = "Lawyer Bill";
        $req_type['2'] = "Publication Bill";
        $req_type['3'] = "Court Fee";
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#req_type").jqxDropDownList({theme: theme,checkboxes: true, autoDropDownHeight: false, promptText: "Type Of Bill",filterable: true,searchMode: 'containsignorecase', source: req_type, width: 150, height: 25});
