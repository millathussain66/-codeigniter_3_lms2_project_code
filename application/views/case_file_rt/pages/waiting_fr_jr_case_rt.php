...
<?php if ($operation=='waiting_fr_jr_case_rt'): ?>
    <?php 
        $report_category_segment = array();


        $report_category_segment['1'] ='Region Wise';
        $report_category_segment['2'] ='District Wise';
        $report_category_segment['3'] ='Territory Wise';


        $report_category=array();

        $report_category['1']='Protfolio Wise';
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#report_category").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Report Catagory", source: report_category, width: 215, height: 25});
            ...
            jQuery("#report_category_segment").jqxDropDownList({theme: theme,checkboxes: true, autoDropDownHeight: false, promptText: "Report Segment",filterable: true,searchMode: 'containsignorecase', source: report_category_segment, width: 215, height: 25});
    ...
    {
        var postdata = jQuery('#waiting_fr_jr_case_rt_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/case_file_rt/get_waiting_fr_jr_case_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="waiting_fr_jr_case_rt_form" id="waiting_fr_jr_case_rt_form" method="post" action="<?= base_url()?>Case_file_rt/waiting_fr_jr_case_rt_xl" enctype="multipart/form-data">
