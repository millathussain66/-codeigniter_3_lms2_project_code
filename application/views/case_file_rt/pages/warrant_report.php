...
<?php if ($operation=='warrant_report'): ?>
    <?php 
        ...
        $report_type['2']='Execution';
        $report_type['3']='Execution & Pending';
        ...
        $reporting_period['6'] ='Region Vs Region';
    ...
    {
        var postdata = jQuery('#warrant_report_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/case_file_rt/get_warrant_report_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="warrant_report_form" id="warrant_report_form" method="post" action="<?= base_url()?>Case_file_rt/warrant_report_xl"enctype="multipart/form-data">
