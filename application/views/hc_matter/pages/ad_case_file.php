...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        jQuery("#next_status").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Select Next Status", source: hc_case_status, width: 250, height: 25});
        ...
        jQuery("#assigned_lawyer").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Select Lawyer", source: lawyer, width: 250, height: 25});
        ...
        jQuery('#portfolio,#case_type,#ac_closing_status,#hc_dealing_officer,#lower_dealing_officer,#deposited_appeal_money,#name_dist,#present_status,#hc_bench,#bench_number,#status,#proposed_type,#region,#territory,#district,#s_proposed_type,#limit,#name,#case_category,#year,#expense_type_1,#district_1,#activities_name_1').focusout(function() {
            commbobox_check(jQuery(this).attr('id'));
        });


        jQuery("#limit").jqxComboBox('val','5');
        jQuery("#s_proposed_type").jqxComboBox('val','Loan');
        s_change_caption();
            ...
            if (item!=null) {
                ...
                if(item.value==3){
                    ...
                    rule1 =[
                        ...
                        { input: '#name', message: 'required!', action: 'keyup, blur', rule: function(input,commit){
                                if(jQuery("#name").val()=='')
                                {
                                    //jQuery("#account_no").focus();
                                    return false;
        ...
        jQuery('#action_form').jqxValidator({
            ...
            { input: '#next_status', message: 'required!', action: 'blur,change', rule: function(input,commit){
                    if(input.val() != '')
                        {
                            var item = jQuery("#next_status").jqxComboBox('getSelectedItem');
                            if(item != null){jQuery("input[name='next_status']").val(item.value);}
                            return true;                
                        }
                        else
                        {
            ...
            { input: '#year', message: 'required!', action: 'blur,change', rule: function(input,commit){
                    if(input.val() != '')
                        {
                            var item = jQuery("#year").jqxComboBox('getSelectedItem');
                            if(item != null){jQuery("input[name='year']").val(item.value);}
                            return true;                
                        }
                        else
                        {
            ...
            /*{ input: '#case_claim', message: 'required', action: 'keyup, blur, change', rule: function (input, commit){
                    if(input.val() == ''){
        ...
        var initGrid2 = function () {
            var source ={
                ...
                url: '<?=base_url()?>index.php/hc_matter/ad_case_file_grid',
                cache: false,
                filter: function()
                {
            ...
            jQuery("#jqxGrid2").jqxGrid({
                ...
                columns: [
                    ...
                    { text: 'AD Mater number', datafield: 'case_no',editable: false, width: '13%'},
                    { text: 'Case Claim', datafield: 'case_claim',editable: false, width: '10%'},
                    { text: 'Case Category', datafield: 'case_category_name',editable: false, width: '10%'},
                    ...
                    { text: 'Next Status', datafield: 'next_status_name',editable: false, width: '20%'},
                    ...
                    { text: 'Year', datafield: 'year',editable: false, width: '13%'},
...
function s_change_caption(){   
    if (jQuery("#s_proposed_type").val()=='') 
    {
        ...
        jQuery("#s_l_or_c_no").html('Loan A/C or Card');
    }
    else
    {
        ...
        var item = jQuery("#s_proposed_type").jqxComboBox('getSelectedItem');
        if (item.value=='Loan') {
            jQuery("#s_l_or_c_no").html('Loan A/C ');
        }
...
function duplicate_check(case_no){
    ...
    jQuery.ajax({
        type: "POST",
        cache: false,
        url: "<?=base_url()?>hc_matter/case_exit_check_ad",
...
function call_ajax_submit(){
    ...
    jQuery.ajax({
        type: "POST",
        cache: false,
        url: "<?=base_url()?>hc_matter/add_edit_action_ad/"+add_edit+"/"+edit_row,
        data : postdata,
        datatype: "json",
        async:false,
        success: function(response){
        ...
        success: function(response){
           // console.log(response);
            ...
            var theme = getDemoTheme();
                    ...
                    jQuery("#next_status").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Select Next Status", source: present_status, width: 250, height: 25});
                    jQuery('#present_status,#next_status').focusout(function() {
                    commbobox_check(jQuery(this).attr('id'));
                });
            },
...
function delete_submit(){
    ...
    jQuery.ajax({
        type: "POST",
        cache: false,
        url: '<?=base_url()?>index.php/hc_matter/delete_action_ad/',
        data : postData,
        datatype: "json",
        success: function(response){
            //console.log(response);
   ...
   // console.log(dataRecord);
    ...
    jQuery.ajax({
        ...
        success: function(response){
            ...
            jQuery('#case_category').jqxComboBox('val',rows.case_category);
            ...
            jQuery("#file_receive_date").val(rows.file_receive_date!=''?rows.file_receive_date:'');
            ...
            jQuery("#next_date").val(rows.next_date!=''?rows.next_date:'');
            ...
            if(rows.present_status==3){
                ...
                jQuery("#memo_date").val(dateformat(sts_data.sts_3_memo_dt));
                jQuery("#gp_no").val(sts_data.sts_3_gp_no);
                jQuery("#gp_date").val(dateformat(sts_data.sts_3_gp_dt));
                ...
                if(sts_data.sts_4_type==1){
                    jQuery("#sts_date").val(dateformat(sts_data.sts_4_date));
                }
            }
                ...
                if(sts_data.sts_11_type==1){
                    jQuery("#sts_date").val(dateformat(sts_data.sts_11_date));
                }
            }else if(rows.present_status==12){
                jQuery("#lcr_memo_no").val(sts_data.sts_12_memo_no);
                jQuery("#memo_date").val(dateformat(sts_data.sts_12_memo_dt));
                jQuery("#gp_no").val(sts_data.sts_12_gp_no);
                jQuery("#gp_date").val(dateformat(sts_data.sts_12_gp_dt));
            }else if(rows.present_status==13){
                jQuery("#wp_amount").val(sts_data.sts_13_amount);
                jQuery("#withdrawn_date").val(dateformat(sts_data.sts_13_date));
            }else if(rows.present_status==18){
                jQuery("#sts_date").val(dateformat(sts_data.sts_18_date));
            }else{
                jQuery('#status').jqxComboBox('clearSelection');
                ...
                if(sts_data[sid]==1){
                    jQuery("#sts_date").val(dateformat(sts_data[sdt]));
                }
            }
            jQuery('#hc_id').val(rows.hc_id);
            jQuery('#hist_id').val(rows.hist_id);
   ...
   var s_proposed_type = jQuery("#s_proposed_type").jqxComboBox('getSelectedItem');
    ...
    else
    {
        ...
        jQuery.ajax({
            ...
            cache: false,
            async:false,
            url: "<?=base_url()?>index.php/hc_matter/search_case_hc/",
            data : postdata,
            datatype: "html",
            success: function(response){                
...
function loadsuit(type){
    ...
    jQuery.ajax({
        type: "POST",
        cache: false,
        url: "<?=base_url()?>hc_matter/get_hc_info_for_ad",
        ...
        success: function(response){
            ...
            /*if(rows.present_status==3){
                jQuery('#status').jqxComboBox('clearSelection');
                jQuery('#status').jqxComboBox('val',rows.sts_3_type!=0?rows.sts_3_type:'');
                jQuery("#lcr_memo_no").val(rows.sts_3_memo_no);
                jQuery("#memo_date").val(rows.sts_3_memo_dt);
                jQuery("#gp_no").val(rows.sts_3_gp_no);
                jQuery("#gp_date").val(rows.sts_3_gp_dt);
            }else if(rows.present_status==4){
                jQuery('#status').jqxComboBox('clearSelection');
                jQuery('#status').jqxComboBox('val',rows.sts_4_type!=0?rows.sts_4_type:'');
                jQuery("#name").val(rows.sts_4_name);
                if(rows.sts_4_type==1){
                    jQuery("#sts_date").val(rows.sts_4_date);
                }
            }
            else if(rows.present_status==8){
                jQuery('#status').jqxComboBox('clearSelection');
                jQuery('#status').jqxComboBox('val',rows.sts_8_type!=0?rows.sts_8_type:'');
            }else if(rows.present_status==19){
                jQuery('#status').jqxComboBox('clearSelection');
                jQuery('#status').jqxComboBox('val',rows.sts_19_type!=0?rows.sts_19_type:'');
            }else if(rows.present_status==11){
                jQuery('#status').jqxComboBox('clearSelection');
                jQuery('#status').jqxComboBox('val',rows.sts_11_type!=0?rows.sts_11_type:'');
                jQuery("#court_name").val(rows.sts_11_cname);
                if(rows.sts_11_type==1){
                    jQuery("#sts_date").val(rows.sts_11_date);
                }
            }else if(rows.present_status==12){
                jQuery("#lcr_memo_no").val(rows.sts_12_memo_no);
                jQuery("#memo_date").val(rows.sts_12_memo_dt);
                jQuery("#gp_no").val(rows.sts_12_gp_no);
                jQuery("#gp_date").val(rows.sts_12_gp_dt);
            }else if(rows.present_status==13){
                jQuery("#wp_amount").val(rows.sts_13_amount);
                jQuery("#withdrawn_date").val(rows.sts_13_date);
            }else if(rows.present_status==18){
                jQuery("#sts_date").val(rows.sts_18_date);
            }else{
                jQuery('#status').jqxComboBox('clearSelection');
                var sid = 'sts_'+rows.present_status+'_type';
                var sdt = 'sts_'+rows.present_status+'_date';
                //alert(rows[sid]);
                jQuery('#status').jqxComboBox('val',rows[sid]!=0?rows[sid]:'');
                if(rows[sid]==1){
                    jQuery("#sts_date").val(rows[sdt]);
                }
            }*/
                        ...
                        <div style="overflow: hidden;" >
                           ...
                           <div style="padding: 10px;display: none;" id="case_form" class="back_image">
                            <form class="form" name="action_form" id="action_form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="hidden" id="hist_id" value="" name="hist_id">
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        <td width="50%">
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td style="font-weight: bold;">Proposed Type<span style="color:red">*</span> </td>
                                                ...
                                                <tr>
                                                    <td style="font-weight: bold;">A/C NAME<span style="color:red">*</span> </td>
                                                    <td ><input name="account_name" type="text" class="" style="width:250px" id="account_name" value="" placeholder="Account Name" /></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight: bold;">AD Mater Number<span style="color:red">*</span> </td>
                                                    <td ><input name="case_no" type="text" class="" style="width:250px" id="case_no" value="" placeholder="AD Mater Number" /></td>
                                                </tr>
                                                <tr>
                                            ...
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td ><div id="case_category" name="case_category" style="padding-left: 3px"></div></td>
                                                    
                                                </tr>
                                                <tr>
                                                    <td style="font-weight: bold;">Case Types<span style="color:red">*</span> </td>
                                                    <td ><div id="case_type" name="case_type" style="padding-left: 3px" onchange="get_case_status()"></div></td>
                                                ...
                                                <tr>
                                                    <td style="font-weight: bold;">Next Status<span style="color:red">*</span> </td>
                                                    <td ><div id="next_status" name="next_status" style="padding-left: 3px"></div></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight: bold;">Next Date<span style="color:red">*</span> </td>
                                                    <td ><input name="next_date" type="text" class="" style="width:250px" id="next_date" value="" placeholder="dd/mm/yyyy" /><script>datePicker ("next_date");</script></td>
                                                </tr>
                                                <tr>
                                                    <td style="font-weight: bold;">Year<span style="color:red">*</span> </td>
                                                ...
                                                <tr>
                                                    <td style="font-weight: bold;">Lawyer Name<span style="color:red">*</span></td>
