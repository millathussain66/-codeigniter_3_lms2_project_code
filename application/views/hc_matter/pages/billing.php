<?php $this->load->view('hc_matter/pages/css'); ?>
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('#expense_type_1,district_1,#activities_name_1,#s_proposed_type,#s_hc_division,#s_case_category,#s_case_type').focusout(function() {
        ...
        var initGrid2 = function () {
            var source ={
                ...
                url: '<?=base_url()?>index.php/hc_matter/hc_expencese_grid',
                cache: false,
                filter: function()
                {
            ...
            jQuery("#jqxGrid2").jqxGrid({
                ...
                columns: [
                    ...
                    { text: 'Division ', datafield: 'division_name',editable: false, width: '15%'},
...
function edit(id,editrow){
   ...
   // console.log(dataRecord);
    ...
    jQuery.ajax({
        type: "POST",
        cache: false,
        url: "<?=base_url()?>hc_matter/get_expence_edit_info",
        data : {[csrfName]: csrfHash,batch_no:id},
        datatype: "json",
        async:false,
        success: function(response){
            //console.log(response);
            ...
            jQuery('#hc_division').html(rows[0].division_name);
            ...
            if(rows[0].hc_division==2){
                jQuery('#module').val('AD Matter');
            }else{
                jQuery('#module').val('HC Matter');
            }
...
function details (id,editrow,operation) {
    var dataRecord = jQuery("#jqxGrid2").jqxGrid('getrowdata', editrow);
    //console.log(dataRecord);
    jQuery("#module_name").val('HC Matter');
    if(operation=='delete'){
    ...
    //console.log(dataRecord);
    jQuery("#r_heading").html('High Court Expenses');
    ...
    jQuery.ajax({
        ...
        data : {[csrfName]: csrfHash,module_name:'HC Matter',id:id},
        datatype: "json",
        async:false,
        success: function(response){
        ...
        success: function(response){
           ...
           // var arr=Object.entries(json.row_info);
            ...
            if(rows!=null){
                ...
                jQuery('#hc_division').html(rows.division_name);
                //jQuery('#cma_id').val(rows.cma_id);
                    ...
                    <div id='jqxTabs'>
                        ...
                        <div style="overflow: hidden;">
                            ...
                            <form method="POST" name="form" id="form"  style="margin:0px;">
                               ...
                               <div style="padding: 15px 10px;width:100%;_height:50px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                    <center>
                           ...
                           <div id="add_form" style="padding: 10px;display: none;">
                            <form class="form" name="action_form" id="action_form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="hidden" id="module" value="HC Matter" name="module">
