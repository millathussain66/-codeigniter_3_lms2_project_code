...
<?php if ($operation=='ac_wise_publication_bill'): ?>
    <?php 
    ...
    {
        var postdata = jQuery('#ac_wise_publication_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/lawyer_bill_rt/ac_wise_publication_form_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="ac_wise_publication_form" id="ac_wise_publication_form" method="post" action="<?= base_url()?>lawyer_bill_rt/ac_wise_publication_xl" enctype="multipart/form-data">
