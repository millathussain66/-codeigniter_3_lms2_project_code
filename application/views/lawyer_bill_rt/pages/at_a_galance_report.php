...
<?php if ($operation=='at_a_galance_report'): ?>
    <?php 
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#from_year").jqxComboBox('val', date);
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="region_wise_report_form" id="region_wise_report_form" method="post" action="<?= base_url()?>lawyer_bill_rt/at_a_galance_report_xl" enctype="multipart/form-data">
                                              ...
                                              <td style="vertical-align: top;">
                                               ...
                                               <!-- <td style="vertical-align: top;">
                                                ...
                                                <td style="vertical-align: top;"  id="xl_button_row">
                                                    <button name="summery" type="submit" formtarget="_blank" name="xlsts" title="All Summery"><img width="27px" style="cursor: pointer;" align="center" src="<?= base_url() ?>images/xl_logo_.png"></button>
                                                </td>
                                                <td style="vertical-align: top;"  id="xl_button_row">
                                                    <button name="Lawyer" type="submit" formtarget="_blank" name="xlsts" title="Lawyer Bill"><img width="27px" style="cursor: pointer;" align="center" src="<?= base_url() ?>images/xl_logo_.png"></button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
