...
<?php if ($operation=='lawyer_bill_summery'): ?>
    <?php 
    ...
    {
        var postdata = jQuery('#lawyer_bill_summery_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/lawyer_bill_rt/lawyer_bill_summery_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="lawyer_bill_summery_form" id="lawyer_bill_summery_form" method="post" action="<?= base_url()?>lawyer_bill_rt/lawyer_bill_summery_xl" enctype="multipart/form-data">
