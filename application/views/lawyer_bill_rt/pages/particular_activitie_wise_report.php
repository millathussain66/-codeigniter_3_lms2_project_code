...
<?php if ($operation=='particular_activitie_wise_report'): ?>
    <?php 
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            jQuery("#lawyer_name").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Lawer's Name", source: lawyer_name, width: 150, height: 25});
    ...
    {
        var postdata = jQuery('#particular_activitie_wise_form').serialize();
        jQuery("#report_result").html('');
        jQuery("#report_generate").hide();
        jQuery("#grid_loading").show();

        jQuery.ajax({
            url: '<?php echo base_url(); ?>index.php/lawyer_bill_rt/particular_activitie_wise_result',
            async:false,
            type: "post",
            data : postdata,
            datatype: "json",
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="particular_activitie_wise_form" id="particular_activitie_wise_form" method="post" action="<?= base_url()?>lawyer_bill_rt/particular_activitie_wise_xl" enctype="multipart/form-data">
