...
<?php if ($operation=='particular_activities'): ?>
    <?php 
                    ...
                    <td valign="top" id="demos" class='rc-all content'>
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                ...
                                <form class="form" name="region_wise_report_form" id="region_wise_report_form" method="post" action="<?= base_url()?>lawyer_bill_rt/particular_activities_xl" enctype="multipart/form-data">
