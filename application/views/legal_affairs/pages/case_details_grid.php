...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        // jQuery("#unit_office").jqxComboBox({theme: theme, promptText: "Select unit office", source: unit_office, width: 150, height: 25});
    ...
    function searchsuit() // customer search 
    {
        ...
        if (item != null && loan_ac == '') {
            ...
            jQuery.ajax({
                ...
                cache: false,
                async: false,
                url: "<?= base_url() ?>index.php/legal_affairs/get_case_details_result/",
                data: postData,
                datatype: "html",
    ...
    function details(id) {
        ...
        jQuery.ajax({
            type: "POST",
            cache: false,
            url: "<?= base_url() ?>legal_affairs/get_case_details_info",
            data: {
                [csrfName]: csrfHash,
                id: val
            },
                ...
                <td valign="top" id="demos" class='rc-all content'>
                    ...
                    <div>
                        <div id='jqxTabs'>
                            ...
                            <div style="overflow: hidden;" class="back_image">
                                <div id="search_area">
                                    <form method="POST" name="form" id="form" style="margin:0px;" action="<?php echo base_url('legal_affairs/make_xl'); ?>">
                                    ...
                                    <input type="hidden" class="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                                        ...
                                        <div class="wrap" id="search_tab_div">
                                            ...
                                            <table id="deal_body" class="search_table_row" style="display:none;width:90%">
                                                ...
                                                <tr>
                                                    <td style="text-align:left;width:10%" colspan="2"><strong>Filling From&nbsp;</strong><input type="text" name="filling_dt_from" placeholder="dd/mm/yyyy" style="width:100px;" id="filling_dt_from" value="">
                                    ...
                                    <table class="" table border="1" id="facility_table" style="border-color:#c0c0c0;">
                                        <thead>
                                            <tr>
                                                ...
                                                <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Filling Date</td>
                                                ...
                                                <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Next Date Case Status</td>
                                                <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">District</td>
                                                <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Legal Region</td>
                                                <td width="6.5%" style="font-weight: bold;text-align:center;word-wrap: break-word;">Protfolio</td>
