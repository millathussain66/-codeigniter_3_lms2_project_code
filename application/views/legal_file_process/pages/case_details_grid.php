...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        //jQuery('#jqxTabs').jqxTabs({initTabContent: initWidgets });
        ...
        //document.getElementById('search_div').setAttribute("style","padding:10px;margin:0 0px;width:98%;overflow-y:scroll;height:"+win_h+"px");
    ...
    function searchsuit() // customer search 
    {
        ...
        if (item != null && loan_ac == '') {
            ...
            jQuery.ajax({
                ...
                cache: false,
                async: false,
                url: "<?= base_url() ?>index.php/legal_file_process/get_case_details_result/",
                data: postData,
                datatype: "html",
    ...
    function details(id) {
        ...
        jQuery.ajax({
            type: "POST",
            cache: false,
            url: "<?= base_url() ?>legal_file_process/get_case_details_info",
            data: {
                [csrfName]: csrfHash,
                id: val
            },
                    ...
                    <div>
                        <div id='jqxTabs'>
                            ...
                            <div style="overflow:hidden;" class="back_image">
                                        ...
                                        <div style="padding: 6px;width:100%;border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                                            ...
                                            <table id="deal_body" class="search_table_row" style="display:none;width:90%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:left;width:10%" colspan="2"><strong>Next Date&nbsp;</strong><input type="text" name="next_date" placeholder="dd/mm/yyyy" style="width:135px;" id="next_date" value="">
                                                        <script type="text/javascript" charset="utf-8">
                                ...
                                <div id="main_div" style="overflow:scroll;min-width: 1000px;min-height: 100px; height: 220px;">
                                    <table class="" table border="1" id="facility_table" style="border-color:#c0c0c0;">
                                        <thead>
                                            <tr>
                                                ...
                                                <td style="font-weight: bold;text-align:center;word-wrap: break-word;">Case Dealings Phone</td>
