...
/* .center {
  ...
  padding: 10px;
    ...
    <script type="text/javascript">
           ...
           jQuery('#proposed_type,#legal_region,#proposed_type_grid,#req_type_grid,#next_date_sts_grid').focusout(function() {
                        ...
                        columns: [
                                ...
                                <? if(SUITFILEDELETE==1){?>
                                    ...
                                    cellsrenderer: function (row) {
                                        ...
                                        else if(<?=SUITFILEDELETE?>=='1' && (check_group_javascript(11) || check_group_javascript(10) || <?=$this->session->userdata['ast_user']['user_system_admin_sts']?>=='2'))
                                        {
                                            return '<div style="text-align:center;margin-top: 5px;  cursor:pointer" onclick="details('+dataRecord.id+',\'delete\','+editrow+','+dataRecord.cma_id+')" ><img align="center" src="<?=base_url()?>images/delete-New.png"></div>';
                                        }
                                        else {
        ...
        jQuery.ajax({
            ...
            success: function(response){
                ...
                if(json.Message=='ok'){
                    ...
                    jQuery("#type_of_case_show").html(json.row_info.type_of_case);
                    jQuery("#type_of_case_name_show").html(json.row_info.type_of_case_name);
                    ...
                    var str1 = json.row_info.case_number.split("-");
                    var case_prefix = str1[0];
                    ...
                    jQuery.each(json['expense'],function(key,obj){
                        ...
                        html_string = '';
                            ...
                            if(json.row_info.req_type==2 && i>3) //For ARA
                            {
                            ...
                            else if(json.row_info.req_type!=2 && i>2) //For Others
                            {
                                html_string += '<img src="<?=base_url()?>images/delete-New.png" onclick="delete_row_expense('+new_counter+')" style="margin-top: 5px;cursor:pointer">';
                            }
                            html_string += '</td>';
                        ...
                        {
                            jQuery('#activities_name_'+new_counter).jqxComboBox({theme: theme, width: 180, autoOpen: false, autoDropDownHeight: false, promptText: "Select Activity", source: court_activities, height: 25});
            ...
            success: function(response){
                ...
                if(json.Message=='ok'){
                    ...
                    jQuery('#next_dt_sts').jqxCheckBox({ checked:true }); 
                        ...
                        jQuery("#next_sts_text").html('');
                        jQuery("#next_sts_text").hide();
                    //jQuery('#prev_lawyer_name').jqxComboBox('val', json.cma_info.lawyer);
                    ...
                    jQuery("#case_claim_amount").val(json.cma_info.st_belance);
                    jQuery("#loan_ac_show").html(json.cma_info.loan_ac);
                    jQuery("#ac_name_show").html(json.cma_info.ac_name);
                    jQuery("#type_of_case_show").html(json.cma_info.type_of_case);
                    jQuery("#type_of_case_name_show").html(json.cma_info.type_of_case_name);
                    ...
                    if(json.cma_info.req_type==2)
                    {
                        for (var i = 1; i <=3; i++) 
                        {
                            ...
                            if(i==1)//For Suit File COST
                            {
                                ...
                                get_expense_amount('activities_name_'+new_counter,json.cma_info.district,new_counter,json.cma_info.req_type);
                            }
    ...
    function clear_form() {
        ...
        jQuery("#type_of_case_name_show").html('');
        jQuery('#expense_counter').val('0');
        jQuery('#expense_body').html('');
                                                                ...
                                                                <td width="50%">
                                                                    <table style="width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="60%" ><strong><span id="type_of_case_name_show"></span></strong></td>
                                                                        </tr>
                                                                        <tr>
                                ...
                                <div style="overflow: hidden;">
                                    ...
                                    <div style="font-family: Calibri; margin: 0 0 -10px 0;font-size:14px;color:#0000cc">
                                        <? if(REASSIGN==1){?>
                                            ...
                                            href="<?=base_url()?>index.php/legal_file_process/bulk_operation_suit_file/blk_rf_main" title=""><input type="button" class="buttonStyle" style="background-color:#c2c2bc;font-size:13px;border-radius: 3px !important;height:30px;width:80px;"  value="Bulk RF" /></a>
                                         <? }?>&nbsp;&nbsp;
                                         <? if(APPROVEREASSIGN==1){?>
                                            <a style="text-decoration:none" onclick="javascript:EOL.messageBoard.open(this.href, (jQuery(window).width()-70), jQuery(window).height(), 'yes'); return false;"
                                            href="<?=base_url()?>index.php/legal_file_process/bulk_operation_suit_file/blk_rf_approve_main" title=""><input type="button" class="buttonStyle" style="background-color:#c2c2bc;font-size:13px;border-radius: 3px !important;height:30px;width:80px;"  value="Bulk AR" /></a>
                                         <? }?>&nbsp;&nbsp;
...
var theme = getDemoTheme();
    rules= [
            ...
            // } },
            { input: '#case_prefix', message: 'required!', action: 'keyup, blur, change', rule: function(input,commit){
                if(jQuery("#case_prefix").val()=='')
                {
                    return false;
                }
                else
            ...
            { input: '#case_prefix', message: 'more than 50 characters', action: 'keyup, blur, change', rule: function (input, commit)
             {
                if(input.val() != '')
                {
                    if(input.val().length>50)
                    {
                        jQuery("#case_prefix").focus();
                        return false;
