...
<? if($option == 'daily_report'){ ?>
	...
	jQuery().ready(function() {
        ...
        var proposed_type = [{value:'', label:'All Type'},{value:'Loan', label:'Loan'},{value:'Card', label:'Card'}];
        jQuery("#proposed_type").jqxComboBox({theme: theme, promptText: "Type",selectedIndex: 0, source: proposed_type, width: '97%', height: 21});
        var limit = [{value:'all', label:'All'},{value:'100', label:'100'},{value:'200', label:'200'},{value:'300', label:'300'},{value:'400', label:'400'},{value:'500', label:'500'}];
...
<div id="container" style="">
    <div id="body"  >
        <div  style="display:block; height:auto">
            <form method="POST" name="form" id="daily_report_search"  style="margin:0px;" action="<?=base_url()?>index.php/legal_notice_rt/daily_report/<?=$menu_group?>/<?=$menu_cat?>">
               ...
               <div style="padding: 0.5%;width:98%;height:60px; border:1px solid #c0c0c0;font-family: Calibri;font-size: 14px">
                    ...
                    <table id="deal_body" style="display:block;width:100%">
                        <tr>
                            ...
                            <td style="text-align:right;width:5%"><strong>Date:&nbsp;&nbsp;</strong> </td>
                            ...
                            <td style="width:3%"><div style="padding-left:1.8%"><strong>Column&nbsp;&nbsp;</strong></div></td>
                            <td style="width:8%"><div style="padding-left:1.8%">
                                <select id="col_xl" tabindex="16" name="col_xl[]" multiple="multiple" style="width:180px">
                                    <option <?php if(!empty($col_xl)){if(in_array(1,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="1">SL No.</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(2,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="2">Proposed Type</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(3,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="3">Loan A/C No.</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(4,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="4">CIF</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(5,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="5">Branch SOL</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(6,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="6">Loan A/C Name</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(7,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="7">Business Type</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(8,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="8">Spouse Name</option>
                                    <!--option <?php //if(!empty($col_xl)){if(in_array(9,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="9">Father Name</option-->
                                    <option <?php if(!empty($col_xl)){if(in_array(10,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="10">Mother Name</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(11,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="11">Loan Segment (Portfolio)</option>
                                    <!--option <?php //if(!empty($col_xl)){if(in_array(12,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="12">Permanent Address</option>
                                    <option <?php //if(!empty($col_xl)){if(in_array(13,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="13">Present Address</option>
                                    <option <?php //if(!empty($col_xl)){if(in_array(14,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="14">Business Address</option-->
                                    <option <?php if(!empty($col_xl)){if(in_array(15,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="15">Current/Updated Address</option>
                                    <!--option <?php //if(!empty($col_xl)){if(in_array(16,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="16">Summon Send To</option-->
                                    <option <?php if(!empty($col_xl)){if(in_array(17,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="17">Region</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(18,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="18">Territory</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(19,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="19">District</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(20,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="20">Unit Office</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(21,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="21">Hold Reason</option>
                                    ...
                                    <option <?php if(!empty($col_xl)){if(in_array(37,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="37">Customer Contact</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(38,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="38">Legal Notice sent by</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(39,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="39">Legal Notice sent Date</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(40,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="40">Lawyer Name</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(41,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="41">Call up Date</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(42,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="42">LN Serial</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(43,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="43">Guarantor</option>
                                    <option <?php if(!empty($col_xl)){if(in_array(44,$col_xl)){echo 'selected';}}else{echo 'selected';}?> value="44">Facility Details</option>
                            ...
                            <td style="width:2%" valign="top">
                                <?php if (count($result) >0 ) { ?>
                                    <button type="submit" formtarget="_blank" name="brxls" title="Legal Notice With BR Serial"><img width="20px" height="20px" align="center" src="<?=base_url()?>images/icon_xls.gif"></button>
                                <?php } ?>
                ...
                <? if($post_sts == 1){?>
                       <table style="font-size:10pt" width="100%" class="input_box" border="0" cellspacing="0" cellpadding="1" align="center">           
                        <tr style="text-align:left; font-weight:bold; background-color: #B8E4F3; border-color: #ccc">
                            ...
                            <th align="left">BR Serial</th>
                            <th align="left">Proposed Type</th>
                            <th align="left">Loan AC</th>
                        ...
                        <?php if (!empty($result)): ?>
                            <?php foreach ($result as $key): ?>
                                <tr>
                                    ...
                                    <td align="left"><?=$key->br_counter;?></td>
                                    ...
                                    <td align="left"><?=$key->legal_notice_sts;?></td>
                                </tr>
                            <?php endforeach ?>
                        <?php else: ?>
