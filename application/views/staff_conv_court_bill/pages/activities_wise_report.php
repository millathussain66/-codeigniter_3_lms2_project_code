...
<?php if ($operation == 'activities_wise_report') : ?>
    <?php
    ...
    <script type="text/javascript">
        ...
        function search_data() {
            var postdata = jQuery('#activities_wise_report_from').serialize();
            jQuery("#report_result").html('');
            jQuery("#report_generate").hide();
            jQuery("#grid_loading").show();

            jQuery.ajax({
                url: '<?php echo base_url(); ?>index.php/staff_conv_court_bill/activities_wise_report_result',
                async: false,
                type: "post",
                data: postdata,
                datatype: "json",
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                <div style="padding: 10px;" class="back_image">
                                    <form class="form" name="activities_wise_report_from" id="activities_wise_report_from" method="post" action="<?= base_url() ?>staff_conv_court_bill/activities_wise_report_xl" enctype="multipart/form-data">
                                        <input type="hidden" class="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                                        <table style="width:90%;" id="tab1Table">
                                            <tbody>
                                                <tr>
                                                    <td style="vertical-align: top;">
                                                        <div style="float:left;" id="from_year" name="from_year" style="padding-left: 3px"></div>
                                                        <div style="margin-left: 15px;float:left;" id="to_year" name="to_year" style="padding-left: 3px"></div>
