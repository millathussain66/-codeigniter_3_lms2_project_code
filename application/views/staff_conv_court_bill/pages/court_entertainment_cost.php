...
<?php if ($operation == 'court_entertainment_cost') : ?>
    <script type="text/javascript">
        ...
        jQuery(document).ready(function() {
            jQuery("#legal_region").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Region", source: legal_region, width: 150, height: 25});
            jQuery("#staff").jqxComboBox({theme: theme,  autoOpen: false,autoDropDownHeight: false, promptText: "Staff", source: staff, width: 150, height: 25});
        });

        function search_data() {
            var postdata = jQuery('#court_entertainment_cost_form').serialize();
            jQuery("#report_result").html('');
            jQuery("#report_generate").hide();
            jQuery("#grid_loading").show();

            jQuery.ajax({
                url: '<?php echo base_url(); ?>index.php/staff_conv_court_bill/court_entertainment_cost_result',
                async: false,
                type: "post",
                data: postdata,
                datatype: "json",
            ...
            <table class="">
                <tr id="widgetsNavigationTree">
                    <td valign="top" align="left" class='navigation'>
                        ...
                        <?php $this->load->view('staff_conv_court_bill/pages/left_side_nav', $operation); ?>
                        <!----====== Left Side Menu End==========----->
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                <div style="padding: 10px;" class="back_image">
                                    <form class="form" name="court_entertainment_cost_form" id="court_entertainment_cost_form" method="post" action="<?= base_url() ?>staff_conv_court_bill/court_entertainment_cost_xl" enctype="multipart/form-data">
                                        <input type="hidden" class="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                                        <table style="width:81%;" id="tab1Table">
                                            <tbody>
                                                <tr>
                                                    <td style="vertical-align: top;">
                                                        <div style="margin-left: 15px;float:left;" id="staff" name="staff" style="padding-left: 3px"></div>

                                                    </td>

                                                    <td style="vertical-align: top;">

                                                        <input type="text" name="filling_dt_from" placeholder="From Date" style="width:100px;" id="filling_dt_from" value="">
                                                        <script type="text/javascript" charset="utf-8">
                                                            datePicker("filling_dt_from");
                                                        </script>
                                                        <input type="text" name="filling_dt_to" placeholder="To Date" style="width:100px;" id="filling_dt_to" value="">
                                                        <script type="text/javascript" charset="utf-8">
                                                    ...
                                                    <td style="vertical-align: top;">
                                                        ...
                                                        <div id="legal_region" name="legal_region"></div>
                                                    </td>



                                                    <td style="vertical-align: top;">
                                                        <input type='button' class="buttonStyle" id='report_generate' name='report_generate' value='Search Report' onclick="search_data()" style="background-color:#fff;color:#000;border-radius: 20px !important;height:30px;width:140px;font-family: sans-serif;font-size: 16px;border: 1px solid #29cdff;" />
