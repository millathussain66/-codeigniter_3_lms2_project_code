...
<?php if ($operation == 'staff_conv_court_bill') : ?>
    <script type="text/javascript">
        ...
        function search_data() {
            var postdata = jQuery('#convance_other_bill_form').serialize();
            jQuery("#report_result").html('');
            jQuery("#report_generate").hide();
            jQuery("#grid_loading").show();

            jQuery.ajax({
                url: '<?php echo base_url(); ?>index.php/staff_conv_court_bill/search_convance_others_bill_result',
                async: false,
                type: "post",
                data: postdata,
                datatype: "json",
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                <div style="padding: 10px;" class="back_image">
                                    <form class="form" name="convance_other_bill_form" id="convance_other_bill_form" method="post" action="<?= base_url() ?>staff_conv_court_bill/convance_other_bill_xl" enctype="multipart/form-data">
