...
<?php if ($operation == 'type_wise_cost') : ?>
    ...
    <script type="text/javascript">
        ...
        function search_data() {
            var postdata = jQuery('#type_wise_cost_form').serialize();
            jQuery("#report_result").html('');
            jQuery("#report_generate").hide();
            jQuery("#grid_loading").show();

            jQuery.ajax({
                url: '<?php echo base_url(); ?>index.php/staff_conv_court_bill/type_wise_cost_result',
                async: false,
                type: "post",
                data: postdata,
                datatype: "json",
                success: function(response) {
                    ...
                    jQuery("#report_result").append(json.str2);
                        ...
                        <div>
                            <div style="overflow: hidden;">
                                <div style="padding: 10px;" class="back_image">
                                    <form class="form" name="type_wise_cost_form" id="type_wise_cost_form" method="post" action="<?= base_url() ?>staff_conv_court_bill/type_wise_cost_lx" enctype="multipart/form-data">
                                        <input type="hidden" class="txt_csrfname" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
                                        <table style="width:81%;" id="tab1Table">
                                            <tbody>
                                                <tr>
                                                    <td style="vertical-align: top;">
                                                        <div style="float:left;" id="staff" name="staff" style="padding-left: 3px"></div>
